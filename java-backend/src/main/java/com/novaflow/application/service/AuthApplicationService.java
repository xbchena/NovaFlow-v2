...
import com.novaflow.application.assembler.UserAssembler;
import com.novaflow.domain.event.DomainEvent;
import com.novaflow.domain.model.auth.User;
import com.novaflow.domain.model.auth.exception.InvalidCredentialsException;
import com.novaflow.domain.model.auth.exception.InvalidTokenException;
import com.novaflow.domain.model.auth.exception.UserNotFoundException;
import com.novaflow.domain.model.auth.valueobject.OpenID;
import com.novaflow.domain.model.auth.valueobject.PhoneNumber;
import com.novaflow.domain.model.auth.valueobject.WeChatInfo;
...
import com.novaflow.infrastructure.external.sms.SmsService;
import com.novaflow.infrastructure.external.wechat.WeChatAuthService;
    ...
    public AuthResponse loginWithWeChat(String code) {
        ...
        if (existingUser.isPresent()) {
            ...
            user = User.createViaWeChat(openid,
                    authResult.getUnionid() != null ? com.novaflow.domain.model.auth.valueobject.UnionID.of(authResult.getUnionid()) : null,
                    weChatInfo);

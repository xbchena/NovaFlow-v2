package com.novaflow.feedback.infra.persistence.impl;
...
import com.novaflow.feedback.infra.persistence.mapper.UserSelectionMapper;
import com.novaflow.feedback.infra.persistence.po.UserSelectionPO;
...
public class UserSelectionRepositoryImpl implements UserSelectionRepository {
    ...
    @Override
    public Optional<UserSelection> findById(SelectionId selectionId) {
    ...
    @Override
    public List<UserSelection> findByUserId(UserId userId) {
    ...
    public Optional<UserSelection> findByUserIdAndVideoId(
     ...
     */
    @Override
    public Optional<UserSelection> findByRecommendationId(RecommendationId recommendationId) {
    ...
    // Note: This method is not in the interface but is used internally
    public List<UserSelection> findRecentByUserId(UserId userId, int limit) {
    ...
    @Override
    public Optional<UserSelection> findLatestByUserId(UserId userId) {
        // 获取最新的选择记录
        List<UserSelectionPO> userSelectionPOList = userSelectionMapper.selectRecentByUserId(
                Long.parseLong(userId.getValue()),
                1
     ...
     * PO 转领域对象
     */
    private UserSelection toDomain(UserSelectionPO userSelectionPO) {
        ...
        return UserSelection.reconstruct(
     ...
     * 领域对象转 PO
     */
    private UserSelectionPO toPO(UserSelection userSelection) {

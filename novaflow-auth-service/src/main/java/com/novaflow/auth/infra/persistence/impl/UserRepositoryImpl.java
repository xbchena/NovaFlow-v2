package com.novaflow.auth.infra.persistence.impl;
...
import com.novaflow.auth.infra.persistence.mapper.UserMapper;
import com.novaflow.auth.infra.persistence.po.UserPO;
...
public class UserRepositoryImpl implements UserRepository {
    ...
    private User toDomain(UserPO userPO) {
        ...
        return User.reconstruct(
                ...
                userPO.getUnionid() != null ? com.novaflow.auth.domain.model.auth.valueobject.UnionID.of(userPO.getUnionid()) : null,
                userPO.getNickname(),
                userPO.getAvatar(),
                userPO.getPhone() != null ? PhoneNumber.of(userPO.getPhone()) : null,
                com.novaflow.auth.domain.model.auth.valueobject.UserPreferences.fromJson(userPO.getPreferences()),
                userPO.getCreatedAt(),
                userPO.getUpdatedAt(),
                userPO.getDeleted()
        );
